...
export const mockLocations: Location[] = [
  { id: 'l1', name: 'AutoPayKe Westlands', address: 'Westlands Rd, Nairobi', city: 'Nairobi', ownerId: 'u5' },
  { id: 'l2', name: 'AutoPayKe Karen', address: 'Karen Rd, Nairobi', city: 'Nairobi', ownerId: 'u5' },
  { id: 'l3', name: 'AutoPayKe CBD', address: 'Kenyatta Ave, Nairobi', city: 'Nairobi', ownerId: 'u5' },
];

export const mockBookings: Booking[] = [
  { id: 'b1', customerId: 'u1', customerName: 'James Mwangi', vehicleId: 'v1', vehicleName: 'Toyota Prado - KDA 123A', serviceId: 's2', serviceName: 'Full Detail', servicePrice: 3000, locationId: 'l1', locationName: 'AutoPayKe Westlands', detailerId: 'u3', detailerName: 'Peter Ochieng', date: '2026-02-25', time: '10:00', status: 'in_progress', paymentStatus: 'completed', paymentMethod: 'mpesa', createdAt: '2026-02-24' },
  { id: 'b2', customerId: 'u2', customerName: 'Grace Wanjiku', vehicleId: 'v3', vehicleName: 'Subaru Forester - KCC 789C', serviceId: 's1', serviceName: 'Express Wash', servicePrice: 500, locationId: 'l2', locationName: 'AutoPayKe Karen', detailerId: 'u4', detailerName: 'Mary Akinyi', date: '2026-02-25', time: '14:00', status: 'confirmed', paymentStatus: 'completed', paymentMethod: 'mpesa', createdAt: '2026-02-23' },
  { id: 'b3', customerId: 'u1', customerName: 'James Mwangi', vehicleId: 'v2', vehicleName: 'Mercedes C200 - KDB 456B', serviceId: 's5', serviceName: 'Ceramic Coating', servicePrice: 15000, locationId: 'l1', locationName: 'AutoPayKe Westlands', date: '2026-02-27', time: '09:00', status: 'pending', paymentStatus: 'pending', paymentMethod: 'crypto', createdAt: '2026-02-25' },
  { id: 'b4', customerId: 'u7', customerName: 'Kevin Otieno', vehicleId: 'v4', vehicleName: 'Nissan X-Trail - KDE 012D', serviceId: 's3', serviceName: 'Interior Clean', servicePrice: 1500, locationId: 'l3', locationName: 'AutoPayKe CBD', detailerId: 'u3', detailerName: 'Peter Ochieng', date: '2026-02-24', time: '11:00', status: 'completed', paymentStatus: 'completed', paymentMethod: 'mpesa', rating: 5, review: 'Excellent work! Car looks brand new.', createdAt: '2026-02-22' },
  { id: 'b5', customerId: 'u2', customerName: 'Grace Wanjiku', vehicleId: 'v3', vehicleName: 'Subaru Forester - KCC 789C', serviceId: 's4', serviceName: 'Engine Wash', servicePrice: 2000, locationId: 'l2', locationName: 'AutoPayKe Karen', detailerId: 'u8', detailerName: 'Lilian Wambui', date: '2026-02-20', time: '15:00', status: 'completed', paymentStatus: 'completed', paymentMethod: 'mpesa', rating: 4, review: 'Good job overall.', createdAt: '2026-02-18' },
  { id: 'b6', customerId: 'u1', customerName: 'James Mwangi', vehicleId: 'v1', vehicleName: 'Toyota Prado - KDA 123A', serviceId: 's1', serviceName: 'Express Wash', servicePrice: 500, locationId: 'l1', locationName: 'AutoPayKe Westlands', detailerId: 'u4', detailerName: 'Mary Akinyi', date: '2026-02-15', time: '09:00', status: 'completed', paymentStatus: 'completed', paymentMethod: 'mpesa', rating: 5, createdAt: '2026-02-14' },
  { id: 'b7', customerId: 'u7', customerName: 'Kevin Otieno', vehicleId: 'v4', vehicleName: 'Nissan X-Trail - KDE 012D', serviceId: 's6', serviceName: 'Upholstery Steam', servicePrice: 2500, locationId: 'l3', locationName: 'AutoPayKe CBD', date: '2026-02-28', time: '13:00', status: 'pending', paymentStatus: 'pending', paymentMethod: 'mpesa', createdAt: '2026-02-25' },
  { id: 'b8', customerId: 'u1', customerName: 'James Mwangi', vehicleId: 'v2', vehicleName: 'Mercedes C200 - KDB 456B', serviceId: 's3', serviceName: 'Interior Clean', servicePrice: 1500, locationId: 'l2', locationName: 'AutoPayKe Karen', detailerId: 'u3', detailerName: 'Peter Ochieng', date: '2026-02-10', time: '10:00', status: 'completed', paymentStatus: 'completed', paymentMethod: 'mpesa', rating: 4, createdAt: '2026-02-08' },
];
